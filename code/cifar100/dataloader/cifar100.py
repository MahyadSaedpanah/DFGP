...
# cf100_dir = '/home/ubuntu/os/ennengyang/orthogonalcl_extension/data/'
# file_dir = '/home/ubuntu/os/ennengyang/orthogonalcl_extension/data/binary_cifar100/'

cf100_dir = Path(r"E:\DFGP\data")
file_dir = Path(r"E:\DFGP\data\binary_cifar100")
...
def get(seed=0,pc_valid=0.10):
    ...
    if not os.path.isdir(file_dir):
        ...
        dat['train'] = datasets.CIFAR100(cf100_dir,train=True,download=False,transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
        dat['test']  = datasets.CIFAR100(cf100_dir,train=False,download=False,transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
        print('sucess')
        for n in range(10):
            data[n]={}
